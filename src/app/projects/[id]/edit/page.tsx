...
import { ChevronLeft, Settings2, BarChart3, Clock } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)] gap-2">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-slate-800">Update Project Reference</h1>
          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Project ID: {id.substring(0, 8)}</p>
        </div>
      </div>
        ...
        <Card className="w-full md:w-72 shrink-0 rounded-sm border-slate-200 shadow-sm flex flex-col bg-slate-50/30">
          <CardHeader className="p-4 border-b bg-white">
            <CardTitle className="text-xs font-bold uppercase flex items-center gap-2">
              <Settings2 className="h-3.5 w-3.5 text-[#46a395]" /> Control Panel
            </CardTitle>
          </CardHeader>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-white rounded-sm border border-slate-100 shadow-sm">
                <h4 className="text-[10px] font-bold text-slate-700 uppercase mb-1 flex items-center gap-1.5">
                  <Clock className="h-3 w-3 text-orange-400" /> Critical Dates
                </h4>
                <p className="text-[9px] text-slate-500 leading-relaxed">
                  Modification of Start or Delivery dates will reflect instantly on the company calendar.
                </p>
              </div>
              <div className="p-3 bg-white rounded-sm border border-slate-100 shadow-sm">
                <h4 className="text-[10px] font-bold text-slate-700 uppercase mb-1 flex items-center gap-1.5">
                  <BarChart3 className="h-3 w-3 text-primary" /> Metrics Impact
                </h4>
                <p className="text-[9px] text-slate-500 leading-relaxed">
                  Status changes update the global portfolio dashboard and reporting KPIs.
                </p>
              </div>
            </div>
          </CardContent>
